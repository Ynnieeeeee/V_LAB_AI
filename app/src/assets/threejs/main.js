...
import { initControls } from './controls.js?v=20260527-liquid-anchored-fill';
import { registerDraggableObject, initInteractionEvents, updateArmsAnimation, draggableObjects } from './interaction.js?v=20260527-liquid-anchored-fill';
import { initChatEvents } from '../js/chatEvents.js?v=20260527-liquid-anchored-fill';
import { initLabLogic } from './lab_logic.js?v=20260527-liquid-anchored-fill';
import { initLights } from './lights.js';
import { initEnvironment } from './environment.js';
import { initMascot, updateMascot } from './mascot.js';
import { setupChemicalCabinet } from './cabinetChemical.js?v=20260527-liquid-anchored-fill';
import { pouringEffect, pouringState } from './interaction.js?v=20260527-liquid-anchored-fill';
